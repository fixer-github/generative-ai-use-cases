...
import { FilterSelect, SelectValue } from '@/components/ui/FilterSelect';
import { Input } from '@aws-amplify/ui-react';
import { RetrievalFilter } from '@aws-sdk/client-bedrock-agent-runtime';
import { useMemo } from 'react';
import { Option } from '@/components/ui/FilterSelect';
    ...
    case 'NUMBER':
      return (
        <div className="flex flex-col items-stretch">
          ...
          />
          <Input
            className="focus:border-blue-600 focus:ring-orange-500/20 grow rounded border border-gray-300 bg-white text-gray-500 shadow-sm transition-all duration-300 hover:border-gray-400 focus:outline-none focus:ring"
            type="text"
