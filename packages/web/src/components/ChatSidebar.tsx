    ...
    <nav className="bg-gray-50 border-r border-gray-200 flex h-screen w-64 flex-col text-sm text-gray-900">
      ...
      <div className="border-b border-gray-200 p-3">
        <button
          ...
          className="hover:bg-gray-200 flex w-full items-center justify-center gap-2 rounded p-2 transition-colors">
      ...
      <div className="border-b border-gray-200 p-3">
        <div className="relative">
          <PiMagnifyingGlass className="absolute left-2 top-1/2 -translate-y-1/2 text-gray-500" />
          <input
            type="text"
            className="w-full rounded bg-white border border-gray-300 py-2 pl-8 pr-2 text-sm text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
