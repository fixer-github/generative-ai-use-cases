  ...
  return (
    <div className="grid grid-cols-12 gap-4">
      ...
      <div className="col-span-12 col-start-1 mx-2 lg:col-span-10 lg:col-start-2 xl:col-span-10 xl:col-start-2">
        ...
        <Card label={t('bot.knowledgeBase')}>
          <div className="space-y-6">
            <div>
              <div className="mb-2 flex items-center justify-between">
                <label className="text-sm font-medium">{t('bot.urls')}</label>
            ...
            <div>
              <div className="mb-2 flex items-center justify-between">
                <label className="text-sm font-medium">{t('bot.s3Urls')}</label>
        ...
        <ExpandableField label={t('bot.generationSettings')}>
          <div className="space-y-4">
            <RowItem>
        ...
        <ExpandableField label={t('bot.chunkingSettings')}>
          <div className="space-y-4">
            <Select
        ...
        <ExpandableField label={t('bot.searchSettings')}>
          <div className="space-y-4">
            <RangeSlider
        ...
        <ExpandableField label={t('bot.webCrawlingSettings')}>
          <div className="space-y-4">
            <Select
              ...
              {webCrawlingFilters.includePatterns.map((pattern, index) => (
                <div key={index} className="mb-2 flex items-center gap-2">
                  <InputText
                    ...
                    className="flex-1"
                  />
                  {index === webCrawlingFilters.includePatterns.length - 1 && (
                    <Button
                      onClick={() =>
                        setWebCrawlingFilters({
                          ...webCrawlingFilters,
              ...
              {webCrawlingFilters.excludePatterns.map((pattern, index) => (
                <div key={index} className="mb-2 flex items-center gap-2">
                  <InputText
                    ...
                    className="flex-1"
                  />
                  {index === webCrawlingFilters.excludePatterns.length - 1 && (
                    <Button
                      onClick={() =>
                        setWebCrawlingFilters({
                          ...webCrawlingFilters,
        ...
        <ExpandableField label={t('bot.guardrails')}>
          <RowItem>
            <div className="flex items-center justify-between">
              <div className="flex items-center">
      ...
      <div className="fixed bottom-0 z-0 flex w-full flex-col items-center justify-center border-t bg-white lg:pr-64 print:hidden">
        <div className="flex w-full max-w-4xl justify-end gap-2 p-4">
